...
export const SCENES = {
  ...
  // ---------------------------------------------------------------- Affaire 2 — Le tribunal fédéral
  "10-courthouse-steps": {
    ...base,
    id: "10-courthouse-steps",
    title: "Les marches du tribunal fédéral",
    room3d: "courthouse-steps",
    station: "bottom",
    focus: 0.3,
    aperture: 0.25,
    reverb: "street",
    ambience: ["amb-courthouse-steps"],
    hotspots: [{ id: "stairs", kind: "waypoint", label: "Monter les marches", at: { x: 0.5, y: 0.8 }, depth: 0.6 }],
  },
  "11-courtroom": {
    ...base,
    id: "11-courtroom",
    title: "Salle d'audience 14B",
    room3d: "courtroom",
    station: "entry",
    focus: 0.3,
    aperture: 0.3,
    reverb: "court",
    ambience: ["amb-courtroom"],
    hotspots: [
      { id: "lectern", kind: "waypoint", label: "S'approcher de la barre", at: { x: 0.5, y: 0.8 }, depth: 0.6 },
      { id: "witness", kind: "object", label: "Le témoin", at: { x: 0.3, y: 0.5 }, depth: 0.4 },
    ],
  },
