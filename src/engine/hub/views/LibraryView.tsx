...
/** Une leçon sur papier à en-tête du cabinet. */
export function LessonArticle({ lesson, footer }: { lesson: Lesson; footer?: React.ReactNode }) {
  return (
    <article className="paper max-h-[65vh] overflow-y-auto px-8 py-6 text-[#2a2118]">
      ...
      <h3 className="mb-3 font-serif text-2xl">{lesson.title}</h3>
